  ...
  <!-- /.box-body -->
    ...
    <!-- include table response -->
      ...
      <div class="table-responsive">
        ...
        @php
         $ths = ['Name ( الاسم )' , 'Type ( النوع )', 'Phone ( رقم الهاتف )' ,'Options ( الخيارات )'];
         $tds = $rows;
         $tdOnly = ['name','functionGetType','phone'];
        @endphp

        @php
         $Otipnsinputs  = [
          is_permited('suppliers','edit') == 1 ? 'admin.shared.buttons.edit' : '',
          is_permited('suppliers','delete') == 1 ? 'admin.shared.buttons.delete' : '',
         ];
        @endphp
