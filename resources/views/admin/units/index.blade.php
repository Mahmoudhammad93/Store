  ...
  <!-- /.box-body -->
    ...
    <!-- include table response -->      
      ...
      <div class="table-responsive">    
        ...
        @php
         $ths = ['Unit (  الوحدة )' , 'Options ( الخيارات )'];
         $tds = $rows;
         $tdOnly = ['name'];
        @endphp
        ...
        @php
         $Otipnsinputs  = [
          is_permited('units','edit') == 1 ? 'admin.shared.buttons.edit' : '',
          is_permited('units','delete') == 1 ? 'admin.shared.buttons.delete' : '',
         ];
        @endphp
