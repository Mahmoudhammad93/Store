...
<!-- TABLE: LATEST ORDERS -->
  ...
  <!-- /.box-body -->
    <div class="box-header clearfix">
      @if( is_permited('categories','add') == 1 )       
      ...
      @if( is_permited('categories','print') == 1 )       
    ...
    <!-- include table response -->      
            <!-- filteration model -->
      @if( is_permited('categories','search') == 1 )       
      ...
      <div class="table-responsive">    
        ...
        @php
         $ths = ['Name ( اسم القسم )' , 'Options ( الخيارات )'];
         $tds = $rows;
         $tdOnly = ['name'];
        @endphp
        ...
        @php
         $Otipnsinputs  = [
          is_permited('categories','edit') == 1 ? 'admin.shared.buttons.edit' : '',
          is_permited('categories','delete') == 1 ? 'admin.shared.buttons.delete' : '',
         ];
        @endphp
