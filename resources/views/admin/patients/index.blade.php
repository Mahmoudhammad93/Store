      ...
      <div class="box-body"><div class="col-md-12">
        ...
        <div class="row" style="margin-top: 20px">
          <div class="col-md-12">
            ...
            @if($rows->count() > 0)
              @php
              $ths = ['Patient.No ( رقم المريض )' ,'Name ( الاسم )' , 'Gender ( الجنس )', 'Phone ( رقم الهاتف )','Date of birth (تاريخ الميلاد)','Notes ( ملاحظات )','Options ( الخيارات )'];
              $tds = $rows;
              $tdOnly = ['patient_no','name','gender','phone','date_of_birth', 'notes'];
              @endphp
              @php
              $Otipnsinputs  = [
