...
<!-- TABLE: LATEST ORDERS -->
  ...
  <!-- /.box-body -->
    <div class="box-header clearfix">
      @if( is_permited('otherinvoices','add') == 1 )
      ...
      @if( is_permited('otherinvoices','print') == 1 )
    ...
    <!-- include table response -->      
            <!-- filteration model -->
      @if( is_permited('otherinvoices','search') == 1 )      
      ...
      <div class="table-responsive">    
        ...
        @php
         $ths = ['Description ( البيان ) ' , 'Value ( القيمة )', 'Date ( التاريخ )' ,'Options ( الخيارات )'];
         $tds = $rows;
         $tdOnly = ['desc','value','date'];
        @endphp

        @php
         $Otipnsinputs  = [
          is_permited('otherinvoices','edit') == 1 ? 'admin.shared.buttons.edit' : '',
          is_permited('otherinvoices','delete') == 1 ? 'admin.shared.buttons.delete' : '',
         ];
        @endphp
