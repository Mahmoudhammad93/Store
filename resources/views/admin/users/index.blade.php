  ...
  <!-- /.box-body -->
    ...
    <!-- include table response -->      
      ...
      <div class="table-responsive">    
        ...
        @php
         $ths = ['Name ( الاسم )' , 'Phone ( رقم الهاتف )' , 'Email ( البريد الالكتروني ) ' ,'Description ( الوصف ) ' ,'Options ( الخيارات ) '];
         $tds = $rows;
         $tdOnly = ['name','phone' , 'email' , 'desc'];
        @endphp

        @php
         $Otipnsinputs  = [
          is_permited('users','edit') == 1 ? 'admin.shared.buttons.edit' : '',
          is_permited('users','delete') == 1 ? 'admin.shared.buttons.delete' : '',
         ];
        @endphp
